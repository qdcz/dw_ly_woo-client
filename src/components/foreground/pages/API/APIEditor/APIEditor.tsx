    ...
    setup(props, { emit }) {
        ...
        return () => (
            <div class={cn("relative")}>
                ...
                >
                    <div v-show={leftSidebarOpen.value} class={cn(
                        ...
                        <div class={cn("p-4")}>
                            <h2 class={cn("text-lg font-semibold text-gray-800 dark:text-gray-200")}>Navigation</h2>
                        </div>
                        <button onClick={() => leftSidebarOpen.value = false} class={cn(
                ...
                <div class={cn("w-full h-full relative")}>
                    {!leftSidebarOpen.value && (
                        <button onClick={() => leftSidebarOpen.value = true} class={cn(
